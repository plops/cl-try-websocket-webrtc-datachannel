    ...
    pc.onicecandidate = function(event) {
        if (event.candidate) {
            ...
            signaling.send(JSON.stringify({
                ...
                "peerDescription": (event.candidate)
            }));;
        };
    };
...
function startup() {
    logger("startup ..");
    document.getElementById("button-connect").addEventListener("click", connect_peers, false);
    document.getElementById("button-disconnect").addEventListener("click", disconnect_peers, false);
    document.getElementById("button-send").addEventListener("click", send_message, false);
